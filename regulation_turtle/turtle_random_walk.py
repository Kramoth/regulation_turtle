...
class RandomWalkClient(Node):
    ...
    def main_loop(self):
        ...
        rand_x=random.uniform(2.0, 9.0)
        rand_y=random.uniform(2.0, 9.0)
        self.send_request(rand_x, rand_y)
        self.request_in_progress = True
        self.get_logger().info(f"Sending waypoint {rand_x}, {rand_y}")
